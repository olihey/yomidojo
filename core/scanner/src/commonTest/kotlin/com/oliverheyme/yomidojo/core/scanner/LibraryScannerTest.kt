...
private class FakeSource(private val tree: Map<String, List<SourceEntry>>) : MangaSource {
    ...
    override fun watch(path: String) = emptyFlow<com.oliverheyme.yomidojo.core.source.ChangeEvent>()
}
