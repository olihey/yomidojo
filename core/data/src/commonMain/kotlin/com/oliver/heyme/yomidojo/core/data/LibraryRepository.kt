...
import com.oliver.heyme.yomidojo.core.domain.Chapter as DomainChapter
import com.oliver.heyme.yomidojo.core.domain.ReadingDirection
import com.oliver.heyme.yomidojo.core.domain.Series as DomainSeries
import com.oliver.heyme.yomidojo.core.domain.ioDispatcher
import com.oliver.heyme.yomidojo.core.domain.nowEpochMillis
import com.oliver.heyme.yomidojo.core.domain.SyncProgressRow
import com.oliver.heyme.yomidojo.core.domain.MetadataAliasRow
import com.oliver.heyme.yomidojo.core.domain.FavoriteRow
import com.oliver.heyme.yomidojo.core.domain.ProgressApplyEntry
import com.oliver.heyme.yomidojo.core.domain.MetadataAliasApplyEntry
import com.oliver.heyme.yomidojo.core.domain.FavoriteApplyEntry
import com.oliver.heyme.yomidojo.core.metadata.RemoteWorkDetails
import com.oliver.heyme.yomidojo.core.data.db.Series as SeriesRow
...
class LibraryRepository(db: MangaDatabase) {
     ...
     * [configBlob] is [com.oliver.heyme.yomidojo.SmbConfig]'s pipe-joined host/share/rootPath/username
     ...
     * [com.oliver.heyme.yomidojo.OneDriveConfig]'s root path (the OAuth tokens live in encrypted
     ...
     * [configBlob] is [com.oliver.heyme.yomidojo.GoogleDriveConfig]'s file id (the OAuth tokens
    ...
    /** Library size before a scan's prune step, so [com.oliver.heyme.yomidojo.LibrarySyncer] can sanity-check
    ...
    /** Whether [seriesId] is already in the library -- lets [com.oliver.heyme.yomidojo.LibrarySyncer] tell a
