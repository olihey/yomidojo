...
import com.oliverheyme.yomidojo.core.domain.Chapter as DomainChapter
import com.oliverheyme.yomidojo.core.domain.ReadingDirection
import com.oliverheyme.yomidojo.core.domain.Series as DomainSeries
import com.oliverheyme.yomidojo.core.domain.ioDispatcher
import com.oliverheyme.yomidojo.core.domain.nowEpochMillis
...
import com.oliverheyme.yomidojo.core.metadata.RemoteWorkDetails
import com.oliverheyme.yomidojo.core.data.db.Series as SeriesRow
...
class LibraryRepository(db: MangaDatabase) {
     ...
     * [configBlob] is [com.oliverheyme.yomidojo.SmbConfig]'s pipe-joined host/share/rootPath/username
     ...
     * [com.oliverheyme.yomidojo.OneDriveConfig]'s root path (the OAuth tokens live in encrypted
     ...
     * [configBlob] is [com.oliverheyme.yomidojo.GoogleDriveConfig]'s file id (the OAuth tokens
    ...
    /** Library size before a scan's prune step, so [com.oliverheyme.yomidojo.LibrarySyncer] can sanity-check
    ...
    /** Whether [seriesId] is already in the library -- lets [com.oliverheyme.yomidojo.LibrarySyncer] tell a
